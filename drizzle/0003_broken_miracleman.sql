...
CREATE TABLE `__new_members` (
	...
	`role` text,
	`deleted_at` integer,
	`created_at` integer DEFAULT '"2025-10-20T07:57:38.940Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-10-20T07:57:38.940Z"' NOT NULL
);
...
CREATE INDEX `members_deleted_at_idx` ON `members` (`deleted_at`);--> statement-breakpoint
...
CREATE TABLE `__new_members_history` (
	...
	`changed_at` integer DEFAULT '"2025-10-20T07:57:38.940Z"' NOT NULL,
	`slug` text NOT NULL,
	`name` text NOT NULL,
	`email` text NOT NULL,
...
CREATE INDEX `members_history_entity_version_idx` ON `members_history` (`entity_id`,`version_number`);--> statement-breakpoint
...
CREATE INDEX `projects_history_entity_version_idx` ON `projects_history` (`entity_id`,`version_number`);--> statement-breakpoint
...
CREATE INDEX `tickets_deleted_at_idx` ON `tickets` (`deleted_at`);--> statement-breakpoint
CREATE INDEX `tickets_created_at_idx` ON `tickets` (`created_at`);--> statement-breakpoint
CREATE INDEX `tickets_title_idx` ON `tickets` (`title`);--> statement-breakpoint
...
ALTER TABLE `__new_tickets_history` RENAME TO `tickets_history`;--> statement-breakpoint
CREATE INDEX `tickets_history_entity_version_idx` ON `tickets_history` (`entity_id`,`version_number`);