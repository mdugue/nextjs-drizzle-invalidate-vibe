...
export const projectFormSchema = z.object({
  ...
  title: z.string().min(MIN_TEXT_FIELD_LENGTH),
  description: z.string().optional(),
  status: z.enum(projectStatus),
  owner: z.string().min(MIN_TEXT_FIELD_LENGTH),
});
...
export const ticketFormSchema = z.object({
  ...
  title: z.string().min(MIN_TEXT_FIELD_LENGTH),
  summary: z.string().min(MIN_TEXT_FIELD_LENGTH),
...
export const memberFormSchema = z.object({
  slug: z.string().min(MIN_SLUG_LENGTH).regex(slugRegex),
  name: z.string().min(MIN_TEXT_FIELD_LENGTH),
